...
dotenv.config();
dotenv.config({ path: path.join(os.homedir(), ".local", "share", "ccswitch-deepseek", ".env"), override: false });
...
const server = http.createServer(async (req, res) => {
  ...
  if (req.method === "GET" && url.pathname === "/v1/models") { res.writeHead(200, { "Content-Type": "application/json" }); return res.end(JSON.stringify({ object: "list", data: [{ id: DEFAULT_MODEL, object: "model", created: 1686935002, owned_by: "deepseek" }] })); }
